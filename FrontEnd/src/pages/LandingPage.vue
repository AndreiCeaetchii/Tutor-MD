        ...
        <div class="relative px-4 mx-auto text-center max-w-7xl sm:px-6 lg:px-8">
          <div class="flex justify-center mb-6">
            <svg width="60" height="25" viewBox="0 0 80 30" class="text-orange-500">
              <path
                d="M0,15 C10,5 20,25 40,15 C60,5 70,25 80,15"
                fill="none"
                stroke="currentColor"
                stroke-width="4"
          ...
          <h2 class="mt-2 text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
            Every tutor is <span class="text-[#5f22d9]">professional</span
            ><br class="hidden lg:inline" />
            and highly qualified
          </h2>

          <p class="max-w-2xl mx-auto mt-4 text-base text-gray-500">
            We connect tutors with students to make learning easier and more engaging. Our platform
            helps build knowledge with guidance, trust, and support.
          </p>
