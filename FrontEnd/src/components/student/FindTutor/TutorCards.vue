...
<template>
  <div class="p-4 mb-5 bg-white border border-gray-100 rounded-lg shadow">
    ...
    <div>
      <div class="mt-3 mb-1.5 text-sm font-bold text-gray-800">You can get teaching service direct at</div>
      <div class="flex justify-center gap-1 sm:justify-start sm:gap-4">
        ...
        >
          <font-awesome-icon :icon="['fas', 'home']" class="w-5 h-5 mb-0.5 sm:mb-1 text-green-500" />
        ...
        >
          <font-awesome-icon :icon="['fas', 'map-marker-alt']" class="w-5 h-5 mb-0.5 sm:mb-1 text-blue-500" />
          <span class="text-xs font-medium text-center text-gray-700 sm:text-sm sm:whitespace-nowrap">Student's home</span>
        </div>
        ...
        <div
          ...
          class="flex flex-col items-center p-1 sm:p-2 transition-colors rounded cursor-pointer w-[30%] sm:w-28 bg-gray-50 hover:bg-gray-200"
        >
          <font-awesome-icon :icon="['fas', 'video']" class="w-5 h-5 mb-0.5 sm:mb-1 text-orange-500" />
          <span class="text-xs font-medium text-center text-gray-700 sm:text-sm">Online</span>
        </div>
      </div>
    </div>
    
    <div class="flex flex-col pt-3 mt-4 border-t border-gray-200 sm:flex-row sm:items-center sm:justify-between">
      <div class="flex items-center gap-1.5 cursor-pointer mb-3 sm:mb-0" 
      ...
      <div class="flex gap-2">
        <button class="flex-1 px-5 py-1.5 text-sm text-gray-500 transition bg-white border border-gray-300 rounded-md sm:flex-none hover:bg-gray-100">Let's chat</button>
        <button class="flex-1 px-5 py-1.5 text-sm text-white transition bg-purple-700 rounded-md sm:flex-none hover:bg-purple-800">View full profile</button>
      </div>
    </div>
  </div>
</template>
