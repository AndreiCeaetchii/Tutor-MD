      ...
      <div class="flex items-center justify-between h-16">
        ...
        <nav class="hidden md:block">
          <div class="flex items-baseline ml-10 space-x-8">
            ...
            <a href="#help" class="text-gray-600 transition-colors hover:text-violet-600">
              Help
            </a>
          </div>
        </nav>
                ...
                <div class="py-1">
                  ...
                  >
                    <div class="flex items-center px-4 py-2.5 mx-2 rounded-lg hover:bg-violet-50">
                      <font-awesome-icon :icon="['fas', 'user']" class="w-4 h-4 mr-3 text-gray-500 transition-colors duration-200 group-hover:text-violet-600" />
                      Profile
                    </div>
                  </a>
                  <a
                  ...
                  >
                    <div class="flex items-center px-4 py-2.5 mx-2 rounded-lg hover:bg-violet-50">
                      <font-awesome-icon :icon="['fas', 'cog']" class="w-4 h-4 mr-3 text-gray-500 transition-colors duration-200 group-hover:text-violet-600" />
                      Settings
                    </div>
                  </a>
                  <a
                  ...
                  >
                    <div class="flex items-center px-4 py-2.5 mx-2 rounded-lg hover:bg-violet-50">
                      <font-awesome-icon :icon="['fas', 'book']" class="w-4 h-4 mr-3 text-gray-500 transition-colors duration-200 group-hover:text-violet-600" />
                      My Courses
                    </div>
                  </a>
                  <a
                  ...
                  >
                    <div class="flex items-center px-4 py-2.5 mx-2 rounded-lg hover:bg-violet-50">
                      <font-awesome-icon :icon="['fas', 'credit-card']" class="w-4 h-4 mr-3 text-gray-500 transition-colors duration-200 group-hover:text-violet-600" />
                      Billing & Payments
                    </div>
                  </a>
                  <a
                  ...
                  >
                    <div class="flex items-center px-4 py-2.5 mx-2 rounded-lg hover:bg-violet-50">
                      <font-awesome-icon :icon="['fas', 'circle-question']" class="w-4 h-4 mr-3 text-gray-500 transition-colors duration-200 group-hover:text-violet-600" />
                      Help & Support
                    </div>
                  </a>
                </div>
                <div class="pt-2 mt-2 border-t border-gray-100">
                  ...
                  >
                    <div class="flex items-center px-4 py-2.5 mx-2 rounded-lg hover:bg-red-50">
                      <font-awesome-icon :icon="['fas', 'right-from-bracket']" class="w-4 h-4 mr-3 text-red-600 transition-colors duration-200 group-hover:text-red-700" />
                      Logout
                    </div>
                  </button>
                </div>
