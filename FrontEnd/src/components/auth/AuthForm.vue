...
<template>
  <div class="flex flex-col max-w-md p-5 mx-auto bg-white sm:p-8">
    ...
    <form @submit.prevent="handleSubmit">
      ...
      <div v-if="!hideEmailPassword" class="mb-3 sm:mb-4">
      ...
      <div v-if="isSignupForm && showPhoneNumber && !hideEmailPassword" class="mb-4 sm:mb-5">
      ...
      <div v-if="!hideEmailPassword" class="mb-4 sm:mb-5">
    ...
    <template v-if="!hideEmailPassword">
